          ...
          <span className="group flex flex-col gap-2">
            ...
            <div className="relative">
              <Input
                ...
                className="h-12 rounded-2xl border-zinc-800 bg-white/5 px-5 pr-14 text-sm text-white placeholder:text-white/35 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition focus-visible:border-amber-100/35 focus-visible:ring-amber-100/10 sm:h-14 sm:text-base"
              />
